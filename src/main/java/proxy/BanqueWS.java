 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.med.com/", wsdlLocation = "http://localhost:9090/?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUEWS_QNAME = new QName("http://ws.med.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.med.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.med.com/", "BanqueServicePort"), BanqueService.class, features);
    }
